...
class YammerUserInviteV2
  ...
  def execute()
    puts "Inviting the user" if @enable_debug_logging
    begin
      group_resp = RestClient.post("https://www.yammer.com/api/v1/invitations.json", {"email" => @parameters['user_email']},
